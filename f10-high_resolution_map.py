...
cmap=cm.rainbow
norml=BoundaryNorm(bounds,cmap.N)
...
#--
print "imshow"
im=ax.imshow(ma.masked_less_equal(visual[0:11000,0:11000],2),cmap=cmap,norm=norml) # interpolation="nearest",origin="upper",
