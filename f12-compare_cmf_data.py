...
#==========
if TAG=="HydroWeb":
    pdfname=odir+"/HydroWeb/hydroweb_cmf_daily_wse_VIC_BC.pdf"
if TAG=="CGLS":
    pdfname=odir+"/CGLS/cgls_cmf_daily_wse_VIC_BC.pdf"
if TAG=="ICESat":
    pdfname=odir+"/ICESat/icesat_cmf_daily_wse_VIC_BC.pdf"
if TAG=="HydroSat":
    pdfname=odir+"/HydroSat/hydrosat_cmf_daily_wse_VIC_BC.pdf"
#============================
