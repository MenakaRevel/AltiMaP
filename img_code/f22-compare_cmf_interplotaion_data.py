...
if TAG=="HydroWeb":
    fname=odir+"/HydroWeb/hydroweb_cmf_linear_daily_wse_VIC_BC.nc"
if TAG=="CGLS":
    fname=odir+"/CGLS/cgls_cmf_linear_daily_wse_VIC_BC.nc"
if TAG=="ICESat":
    fname=odir+"/ICESat/icesat_linear_cmf_daily_wse_VIC_BC.nc"
if TAG=="HydroSat":
    fname=odir+"/HydroSat/hydrosat_cmf_linear_daily_wse_VIC_BC.nc"
...
#==========
if TAG=="HydroWeb":
    pdfname=odir+"/HydroWeb/hydroweb_cmf_linear_daily_wse_VIC_BC.pdf"
if TAG=="CGLS":
    pdfname=odir+"/CGLS/cgls_cmf_linear_daily_wse_VIC_BC.pdf"
if TAG=="ICESat":
    pdfname=odir+"/ICESat/icesat_cmf_linear_daily_wse_VIC_BC.pdf"
if TAG=="HydroSat":
    pdfname=odir+"/HydroSat/hydrosat_cmf_linear_daily_wse_VIC_BC.pdf"
#============================
with PdfPages(pdfname) as pdf:
    ...
    d = pdf.infodict()
    d['Title'] = TAG+' and VIC BC comparison'
