...
if TAG=="HydroWeb":
    fname='hydroweb_cmf_linear_daily_wse_VIC_BC.nc'
if TAG=="CGLS":
    fname='cgls_cmf_linear_daily_wse_VIC_BC.nc'
if TAG=="ICESat":
    fname='icesat_cmf_linear_daily_wse_VIC_BC.nc'
if TAG=="HydroSat":
    fname='hydrosat_cmf_linear_daily_wse_VIC_BC.nc'
#-------
